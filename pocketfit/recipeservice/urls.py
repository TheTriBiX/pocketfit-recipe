...
urlpatterns = [
    ...
    path('ingridients/<str:id>', views.IngredientsDetailView.as_view(), name='ingredients-detail'),
    ...
    path('ingridients/update/<str:id>', views.IngredientsUpdateView.as_view(), name='ingredients-update'),
    path('ingridients/delete/<str:id>', views.IngredientsDeleteView.as_view(), name='ingredients-delete'),
